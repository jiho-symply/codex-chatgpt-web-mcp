...
Current stable CGW build: **v0.8.1** (`0790508bd966`). The install URL is pinned to this immutable Git commit so `npx` cannot reuse an older build behind the same floating URL.
